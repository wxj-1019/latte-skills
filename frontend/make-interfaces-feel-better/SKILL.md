...
description: "Use for pixel-level interaction details and micro-polish of UI components - concentric border radius, optical alignment, hit and click areas, hover and enter/exit animations, icon stroke and states, font smoothing, tabular numbers, image outlines, box shadows, motion restraint. Supports quick and full review modes. For comprehensive design direction or full-interface audits use impeccable."
---
