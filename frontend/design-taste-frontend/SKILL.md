...
description: "Use for landing pages, portfolios, and redesigns where the design direction should be inferred from the brief, target audience, and existing brand assets - audit-first on redesigns, anti-slop, strict pre-flight check. Prefer frontend-design for general component or page aesthetics not tied to a marketing brief."
---
